...
const productCard = (obj) => {
    ...
    const {brand, category, description, discountPercentage, id, price, rating, stock, thumbnail, title,/** is arrays */ images} = obj;

    document.getElementById("root").innerHTML += `
    <figure class="card" onclick="renderDetail(${id})">
        <div>
...
const initPage = () => {
/**
 * by using a ternary operator we can determine if the ApiData is empty or not
